    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-sm mx-4 bg-white rounded-2xl border border-cut-warm/40 shadow-xl overflow-hidden">
        ...
        <div className="bg-cut-deep px-6 py-5 text-center">
          <p className="text-xs font-bold uppercase tracking-widest text-cut-warm/70 mb-1">Export Limit Reached</p>
          <h2 className="text-xl font-bold text-cut-base">Upgrade to Pro</h2>
        </div>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="bg-cut-base rounded-xl p-4 text-center">
            ...
            <p className="text-xs text-cut-mid mt-1">exports used this month</p>
